...
namespace DefaultCQRS.Controllers
{
    ...
    public class CategoryApiController : DefaultCommandControllerBase<long, Category, CategoryDto, CreateCategoryDto, CategoryDto, UpdateCategoryDto>
    {
        public CategoryApiController(IMediator mediator, IDistributedCache appCache, IPrincipal httpContextAccessor, IAuthorizationService service, IMapper mapper) : base(mediator, appCache, httpContextAccessor, service, mapper)
        {
        }
